...
export default function About() {
   ...
   const [btnText, setBtnText] = useState('Enable Dark Mode'); //  initial state (text) of the dark mode btn
  ...
  return (
    <div className='container' style={darkStyle}>
        <h1 className='aboutHead my-3'>About Us</h1>
        <div className="accordion" id="accordionExample">
            <div className="accordion-item">
                ...
                <div id="collapseOne" className="accordion-collapse collapse show" style={darkStyle} aria-labelledby="headingOne" data-bs-parent="#accordionExample">
            ...
            <div className="accordion-item">
                ...
                <div id="collapseTwo" className="accordion-collapse collapse" style={darkStyle} aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div className="accordion-body">
            ...
            <div className="accordion-item">
                ...
                <div id="collapseThree" className="accordion-collapse collapse" style={darkStyle} aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div className="accordion-body">
